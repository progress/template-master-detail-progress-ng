...
export class MyListSelectorComponent implements OnInit {
    ...
    private _customerEditModel: Customer;
    ...
    ngOnInit(): void {
        ...
        this._customerEditModel = this._customerEditService.getEditableCustomerById(customerId);
    }

    onSelectorTap(): void {
        const title = `Select Customer ${capitalizeFirstLetter(this.tag)}`;
