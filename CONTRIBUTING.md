Contribute to the JSDO Starter Template
===
...
Report an Issue
===
If you find a bug in the source code or a mistake in the documentation, you can submit an issue to our <a href="https://github.com/progress/template-master-detail-progress-ng">GitHub Repository</a>.
...
Request a Feature
===
You can request a new feature by submitting an issue with the *enhancement* label to our <a href="https://github.com/progress/template-master-detail-progress-ng">GitHub Repository</a>.
If you want to implement a new feature yourself, consider submitting it to the <a href="https://github.com/progress/template-master-detail-progress-ng">GitHub Repository</a> as a Pull Request.
...
```bash
    git clone git@github.com:progress/template-master-detail-progress-ng.git
```
...
[Back to Top][1]
[1]: #contribute-to-the-jsdo-starter-template
